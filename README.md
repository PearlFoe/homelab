...
[v1.1](docs/en/v1/README.md) – 4-node k3s cluster on Dell Optiplex 3060 + Ugreen NAS, MikroTik networking, Ansible-managed configuration.

## Version history

| Version | Period | Description |
|---------|--------|-------------|
| [v1.1](docs/en/v1/README.md) | May 2026 – present | Added Ugreen DXP4800 Pro NAS with TrueNAS, 2x 10 TB WD Red Plus in ZFS mirror |
